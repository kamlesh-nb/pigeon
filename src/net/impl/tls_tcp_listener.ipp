...
public:
    ...
    tls_tcp_listener(cache* p_cache){ msgParser = new msg_parser; requestHandler = new request_handler(p_cache); }
    ...
    virtual void add_route(std::string route, int method, request_process_step_cb func) override {

    }

    virtual void add_filter(std::string filter, request_process_step_cb func) override {
