...
auto pigeon::net::get_cached_response(bool is_api, string_builder* sb) -> void {
...
auto pigeon::net::get_header_field(HttpHeader hdr) -> const char* {
...
auto pigeon::net::get_header_field(HttpHeader hdr, string& data) -> void {
    for (header *m = headers; m->header_id; ++m) {
        if (m->header_id == static_cast<int>(hdr)) {
            data += m->header_field;
        }
...
auto pigeon::net::get_status_phrase(HttpStatus status, string_builder* sb) -> void {
...
auto pigeon::net::get_status_msg(HttpStatus status) -> const char* {
...
auto pigeon::net::get_err_msg(const char* msg, bool is_api, HttpStatus status, string_builder* sb) -> void {
...
auto pigeon::net::get_mime_type(string &extension) -> const string {
...
auto pigeon::net::get_log_type(LogType type) -> const string {
...
auto pigeon::net::get_severity(Severity severe) -> const string {
...
auto pigeon::net::url_decode(const string &in, string &out) -> bool {
...
auto pigeon::net::deflate_string(string& in, string& out) -> unsigned long {
