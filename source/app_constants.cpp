...
static string cached_date_response = " Date: ";
static string api_cached_response = "\r\nConnection: close\r\nServer: pigeon\r\nAccept_Range: bytes\r\nContent-Type: application/json\r\n";


string app_constants::get_cached_response(bool is_api){
...
string app_constants::get_header_field(HttpHeader hdr){
...
string  app_constants::get_status_phrase(HttpStatus status){
...
string  app_constants::get_status_msg(HttpStatus status){
...
string app_constants::get_mime_type(string& extension){
...
string app_constants::get_log_type(LogType type) {
...
string app_constants::get_severity(Severity severe) {
